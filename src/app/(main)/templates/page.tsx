...
const sortOptions = ['Latest', 'Popular', 'Name A-Z'];
...
export default function TemplatesPage() {
  ...
  return (
    <div className="min-h-screen relative">
      {/* Center White Section with Shadow */}
      <div className="max-w-7xl mx-auto bg-white min-h-screen px-4 sm:px-6 lg:px-12 xl:px-16 pt-24 sm:pt-32 lg:pt-40 pb-12 sm:pb-16 lg:pb-20 shadow-2xl">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 max-w-3xl leading-relaxed">
            Select a beautiful template to start building your website.<br className="hidden sm:block" />
            <span className="sm:inline"> </span>All templates are fully customizable and responsive.
          </p>
        </motion.div>
          ...
          {filteredTemplates.map((template) => (
            ...
            >
              ...
              <div className="bg-white rounded-lg sm:rounded-xl overflow-hidden border-2 border-gray-100 hover:border-gray-300 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                {/* Template Preview (Empty placeholder) */}
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center relative overflow-hidden">
                  <div className="text-gray-300 text-center group-hover:scale-110 transition-transform duration-300">
                    ...
                    <p className="text-xs sm:text-sm font-medium">Template Preview</p>
                  </div>
